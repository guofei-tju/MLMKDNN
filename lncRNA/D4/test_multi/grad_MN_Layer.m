function [betas,betasf] = grad_MN_Layer(betas,betasf,KCOMList1,KNet1,...
                                         ...
                                         Theta,Ytrain,LR,sig,a2,p2,a3,p3,...
    ...
    %N_features个网络，每个网络两层，每层四个节点
    for i = 1:N_features
        for l = 2:-1:1
            for k = 1:num_nodes
                switch l
                    case 1
                        Kd(:,:,k,l,i) = TwoLayerDeriv(KCOMList1(:,1,i),KNet1(:,k,1,i),betasf(i),betas(2,:,i),sig,a2,p2,a3,p3,num_nodes); 
                    case 2
