...
%%%%%%%%%%%%%%%%%%%%%%%%%
%   intruduction:
%   each target and drug generate four network using  features respectively，
...
%     betas1(:,:,i) = rand_initialize(nLayers,num_nodes);   
end
for i = 1:N_features2
    betas2(1:nLayers,:,i) = ones(nLayers,num_nodes)./num_nodes;
%     betas2(:,:,i) = rand_initialize(nLayers,num_nodes);
end
