...
% disease_number = [58] ;
% RNA_number = [183 228 413	414	415	];%416	417	418	419	420

% disease_number = [87] ;
% RNA_number = [572	573	574	575	576	577	
% ];%578	579	580	581	582

% disease_number = [81] ;
% RNA_number = [457 541	542	543	544	545	
% ];%546	547	548	549	550

disease_number = [69] ;
RNA_number = [183 85 445 463	464	465	466	
];%467	468	469	470	471
